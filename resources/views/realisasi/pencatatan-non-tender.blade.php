...
<style>
    ...
    .non-tender-table tbody tr:nth-child(even) {
        background: #d9d9d9;
    }

    .non-tender-table .number-cell {
        text-align: right;
        white-space: nowrap;
    }

    .non-tender-table .center-cell {
        text-align: center;
        white-space: nowrap;
    }

    .non-tender-table .total-row td {
        background: #bfbfbf;
        font-weight: 700;
    }
...
<div class="non-tender-report-card">
    <div class="non-tender-title mb-3">Evaluasi Data Pencatatan Non Tender</div>

    <form method="GET" action="{{ route('realisasi.pencatatan.non-tender') }}" class="row g-2 align-items-end mb-3">
        <div class="col-md-2">
