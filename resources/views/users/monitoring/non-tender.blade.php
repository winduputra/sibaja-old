...
<div class="container">
    ...
    <div class="header-section">
        <h1 class="header-title">
            ...
            Monitoring Kontrak Non-Tender
        </h1>
        <p class="header-subtitle">Data non-tender yang telah selesai dan status kontraknya</p>
    </div>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th style="width: 150px;" class="text-center">Total Non-Tender Selesai</th>
    ...
    @foreach ($data as $i => $item)
        <tr>
            ...
            <td>
                <a href="{{ route('monitoring.kontrak.non_tender_detail', ['satker' => urlencode($item['nama_satker'])]) }}?tahun={{ request('tahun_anggaran', $tahun) }}" 
                   class="link-primary">
                    {{ $item['nama_satker'] }}
                </a>
            </td>
            <td class="text-center">{{ $item['total_non_tender_selesai'] }}</td>
            <td class="text-right amount-cell">{{ number_format($item['total_pagu'], 0, ',', '.') }}</td>
            <td class="text-right">{{ $item['kontrak_belum_input'] }}</td>
        </tr>
    @endforeach
@else
    <tr>
    ...
    <div class="summary-card">
        <div class="summary-grid">
            <div class="summary-item">
                <div class="summary-label">Total Non-Tender Selesai Tahun {{ request('tahun_anggaran', $tahun) }}</div>
                <div class="summary-value amount-cell">{{ number_format($totalNonTenderSelesai, 0, ',', '.') }}</div>
            </div>
            <div class="summary-item">
