...
<div class="container mx-auto px-4 py-4">
    <div class="header-section">
        ...
        <p class="header-subtitle">Berikut adalah daftar tender yang telah selesai namun belum memiliki data kontrak</p>
    </div>
    ...
    <div class="action-buttons">
        ...
        <a href="{{ route('monitoring.kontrak.detail.pdf', ['tahun' => $tahun, 'satker' => urlencode($satker)]) }}" 
           target="_blank"
            ...
            <tbody>
                @forelse ($data as $i => $item)
                    <tr>
                        ...
                        <td class="font-mono">{{ $item->kd_tender }}</td>
                    ...
                    <tr>
                        <td colspan="4">
                            <div class="empty-state">
                                ...
                                <p class="empty-text">Tidak ada data tender yang belum input kontrak</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
